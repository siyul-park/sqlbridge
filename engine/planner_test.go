				...
				Input: &FilterPlan{
					Input: &AliasPlan{
						Input: &ScanPlan{
							...
							Expr: &EqualExpr{
								Left:  &IndexExpr{Left: &ColumnExpr{Value: &sqlparser.ColName{Name: sqlparser.NewColIdent("id"), Qualifier: sqlparser.TableName{Name: sqlparser.NewTableIdent("t1")}}}, Right: &LiteralExpr{Value: sqltypes.NewInt64(0)}},
