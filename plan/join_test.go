	...
	tests := []struct {
	...
	}{
		{
			plan: &Join{
				...
				Right: &Alias{
					Input: &Scan{Catalog: catalog, Table: sqlparser.TableName{Name: sqlparser.NewTableIdent("t2")}},
					As:    sqlparser.NewTableIdent("t2"),
				},
				Kind: sqlparser.JoinStr,
				Expr: &eval.Equal{
					Left:  &eval.Column{Value: &sqlparser.ColName{Name: sqlparser.NewColIdent("id"), Qualifier: sqlparser.TableName{Name: sqlparser.NewTableIdent("t1")}}},
					Right: &eval.Column{Value: &sqlparser.ColName{Name: sqlparser.NewColIdent("id"), Qualifier: sqlparser.TableName{Name: sqlparser.NewTableIdent("t2")}}},
				},
			},
		...
		},
		{
			plan: &Join{
				...
				Kind: sqlparser.JoinStr,
				Expr: &eval.Uniform{Input: &eval.Column{Value: &sqlparser.ColName{Name: sqlparser.NewColIdent("id")}}},
			},
			cursor: schema.NewInMemoryCursor([]schema.Row{
				{
					Columns: []*sqlparser.ColName{{Name: sqlparser.NewColIdent("id"), Qualifier: sqlparser.TableName{Name: sqlparser.NewTableIdent("t1")}}, {Name: sqlparser.NewColIdent("name"), Qualifier: sqlparser.TableName{Name: sqlparser.NewTableIdent("t1")}}, {Name: sqlparser.NewColIdent("id"), Qualifier: sqlparser.TableName{Name: sqlparser.NewTableIdent("t2")}}, {Name: sqlparser.NewColIdent("name"), Qualifier: sqlparser.TableName{Name: sqlparser.NewTableIdent("t2")}}},
